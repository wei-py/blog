import{_ as s,c as n,o as e,ah as l}from"./chunks/framework.DEXV2HBK.js";const u=JSON.parse('{"title":"布局","description":"","frontmatter":{"title":"布局","date":"2025-07-03T00:00:00.000Z","category":"css","tags":["布局","css"]},"headers":[],"relativePath":"posts/css/布局.md","filePath":"posts/css/布局.md"}'),t={name:"posts/css/布局.md"};function p(i,a,c,o,r,d){return e(),n("div",null,a[0]||(a[0]=[l(`<h2 id="水平居中的选择流程图-图文逻辑" tabindex="-1">水平居中的选择流程图（图文逻辑） <a class="header-anchor" href="#水平居中的选择流程图-图文逻辑" aria-label="Permalink to &quot;水平居中的选择流程图（图文逻辑）&quot;">​</a></h2><ul><li>行内靠文本，块级靠外边，其他靠 Flex 或定位</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>是否是块级元素？</span></span>
